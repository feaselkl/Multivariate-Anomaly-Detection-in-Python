...
from src.app.models.multivariate3 import *
import pandas as pd
import pytest
...
@pytest.mark.parametrize("df_input, sensitivity_score, number_of_anomalies", [
    (sample_input, 100, 6),     # Was 3 in COF-only, 8 in COF-and-LOCI
    (sample_input, 50, 6),      # Was 3 in COF-only, 8 in COF-and-LOCI
    (sample_input, 40, 6),      # Was 3 in COF-only, 8 in COF-and-LOCI
    (sample_input, 25, 6),      # Was 3 in COF-only, 8 in COF-and-LOCI
    (sample_input, 5, 5),       # Was 3 in COF-only
    (sample_input, 1, 3),       # Was 3 in COF-only, 2 in COF-and-LOCI
    (sample_input, 0, 0),
])
...
@pytest.mark.parametrize("df_input, max_fraction_anomalies, number_of_anomalies", [
    (sample_input, 1.0, 6),     # Was 3 in COF-only, 8 in COF-and-LOCI
    (sample_input, 0.8, 6),     # Was 3 in COF-only, 8 in COF-and-LOCI
    (sample_input, 0.6, 6),     # Was 3 in COF-only, 8 in COF-and-LOCI
    (sample_input, 0.4, 6),     # Was 3 in COF-only, 8 in COF-and-LOCI
    (sample_input, 0.2, 6),     # Was 3 in COF-only, 8 in COF-and-LOCI
    (sample_input, 0.1, 6),     # Was 3 in COF-only, 8 in COF-and-LOCI
    (sample_input, 0.01, 1),
])
